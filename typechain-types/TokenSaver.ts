...
export interface TokenSaverInterface extends utils.Interface {
  contractName: "TokenSaver";
  functions: {
...
export interface TokenSaver extends BaseContract {
  contractName: "TokenSaver";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenSaverInterface;
